...
#
#
# def PreActResNet18(classes):
#     return PreActResNet(PreActBlock, [2,2,2,2], num_classes=classes)
#
# def PreActResNet34():
...
class PreActResNet(nn.Module):
    def __init__(self, block, num_blocks, channels=3, num_classes=100):
        super(PreActResNet, self).__init__()
        self.in_planes = 64
...
def PreActResNet18(channels, num_classes):
    return PreActResNet(PreActBlock, [2,2,2,2], channels=channels, num_classes=num_classes)
...
def PreActResNet101(channels, num_classes):
    return PreActResNet(PreActBottleneck, [3,4,23,3], channels=channels, num_classes=num_classes)
